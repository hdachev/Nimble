...
struct CONSTANTS
{
    ...
    static const int TRANSMITTANCE_CHANNELS = 3;
    static const int TRANSMITTANCE_SIZE     = TRANSMITTANCE_WIDTH * TRANSMITTANCE_HEIGHT;
    ...
    static const int SCATTERING_WIDTH       = SCATTERING_NU * SCATTERING_MU_S;
    static const int SCATTERING_HEIGHT      = SCATTERING_MU;
    static const int SCATTERING_DEPTH       = SCATTERING_R;
    static const int SCATTERING_CHANNELS    = 4;
    static const int SCATTERING_SIZE        = SCATTERING_WIDTH * SCATTERING_HEIGHT * SCATTERING_DEPTH;
    static const int IRRADIANCE_WIDTH       = 64;
