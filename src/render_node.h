...
namespace nimble
{
	...
	enum RenderNodeFlags
	{
		...
		NODE_USAGE_PER_SCENE_UBO = BIT_FLAG(2),
		NODE_USAGE_STATIC_MESH = BIT_FLAG(3),
		NODE_USAGE_SKELETAL_MESH = BIT_FLAG(4),
		NODE_USAGE_MATERIAL_ALBEDO = BIT_FLAG(5),
		NODE_USAGE_MATERIAL_NORMAL = BIT_FLAG(6),
		NODE_USAGE_MATERIAL_METAL_SPEC = BIT_FLAG(7),
