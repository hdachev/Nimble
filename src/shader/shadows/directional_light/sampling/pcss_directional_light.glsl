...
const vec2 kPoissonSamples[25] = vec2[](
...
#elif POISSON_DISK_SAMPLE_COUNT == 32

const vec2 kPoissonSamples[32] = vec2[](
...
#elif POISSON_DISK_SAMPLE_COUNT == 64
...
#elif POISSON_DISK_SAMPLE_COUNT == 100

const vec2 kPoissonSamples[100] = vec2[](
...
#elif POISSON_DISK_SAMPLE_COUNT == 128

const vec2 kPoissonSamples[128] = vec2[](
